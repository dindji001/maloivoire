...
class PayementButtonSheetPrecommander extends StatefulWidget {
  final int prixTotal;
  final int deliveryPrice;
  final int quantity_order;
  final int order_price;
  final String numberPhne;
  ...
  required this.numberPhne,
  });

  @override
  State<PayementButtonSheetPrecommander> createState() => _PayementButtonSheetPrecommanderState();
}

class _PayementButtonSheetPrecommanderState extends State<PayementButtonSheetPrecommander> {
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Text(
                        "Cliquer sur le bouton Pre-Commander pour envoyer votre commande a l'administrateur",
                      ),
